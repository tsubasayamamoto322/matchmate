...
このディレクトリには、MatchMateアプリケーションの設計ドキュメントが含まれています。

**MatchMate**は、サッカーチーム向けの試合出欠管理およびポジション設定アプリケーションです。監督と選手が効率的にコミュニケーションを取り、試合の準備を円滑に進めることができます。

## ドキュメント一覧

| ファイル | 説明 |
|----------|------|
| [01_システム概要.md](./01_システム概要.md) | プロジェクト概要、技術スタック、アーキテクチャ |
| [02_機能要件.md](./02_機能要件.md) | ユーザーロール、機能一覧、ビジネスルール |
| [03_データベース設計.md](./03_データベース設計.md) | ER図、テーブル定義、RLS設計 |
| [04_画面設計.md](./04_画面設計.md) | 画面一覧、画面遷移図、ワイヤーフレーム |
| [05_コンポーネント設計.md](./05_コンポーネント設計.md) | コンポーネント構成、Props/Emits定義、Composables |
| [06_API設計.md](./06_API設計.md) | Supabaseクエリパターン、データ操作フロー |
| [07_非機能要件.md](./07_非機能要件.md) | パフォーマンス、セキュリティ、レスポンシブ対応 |
...
- [.cursor/plans/](../../.cursor/plans/) - 開発計画ドキュメント
