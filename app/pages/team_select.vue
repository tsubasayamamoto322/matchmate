    ...
    <main class="flex-1 p-4 sm:p-8">
      <div class="w-full max-w-4xl mx-auto">
          <div class="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8">
            <div>
              <h2 class="text-gray-900 text-2xl sm:text-3xl font-bold mb-2">チームの選択</h2>
            ...
            <div class="flex gap-3">
              ...
              <button
                ...
                class="w-full sm:w-auto px-4 py-2 bg-blue-600 text-white text-sm font-bold rounded-lg hover:bg-blue-700 transition-colors shadow-lg flex items-center justify-center gap-2"
              >
          ...
          <div class="bg-white rounded-xl shadow-lg p-4 sm:p-8 mb-6 sm:mb-8">
            <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">参加中のチーム</h3>
            ...
            <div v-else class="space-y-4">
              <div
                ...
                class="w-full bg-white rounded-xl shadow-lg p-4 sm:p-6 flex flex-col sm:flex-row gap-4 hover:shadow-2xl transition-all transform duration-200 border-2 border-transparent hover:border-green-400 cursor-pointer"
              >
                <div class="mx-auto sm:mx-0 flex-shrink-0 relative">
                  <div class="w-20 h-20 sm:w-32 sm:h-32 bg-gradient-to-br from-green-300 to-green-600 rounded-lg overflow-hidden shadow-lg">
                    <img 
                  ...
                  <div class="absolute -top-2 -right-2 w-6 h-6 sm:w-8 sm:h-8 bg-white rounded-full shadow-lg flex items-center justify-center text-sm sm:text-lg">⚽</div>
                </div>
                <div class="flex-1 flex flex-col justify-between text-center sm:text-left">
                  <div>
                    <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-2">{{ team.team_name }}</h3>
          ...
          <div v-if="!isManager" class="bg-white rounded-xl shadow-lg p-4 sm:p-8">
            <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-4 sm:mb-6">参加申請待機中</h3>
            ...
            <div v-else class="space-y-4">
              ...
              <div
                ...
                class="bg-yellow-50 rounded-xl p-4 sm:p-6 flex flex-col sm:flex-row gap-4 border-2 border-yellow-200"
              >
                <div class="mx-auto sm:mx-0 flex-shrink-0">
                  <div class="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-yellow-300 to-yellow-600 rounded-lg overflow-hidden shadow-lg">
                    <img 
                ...
                <div class="flex-1 flex flex-col justify-between text-center sm:text-left">
                  <div>
                    <h3 class="text-base sm:text-lg font-bold text-gray-900 mb-2">{{ team.teams?.team_name }}</h3>
                  ...
                  <div class="flex flex-col sm:flex-row items-center gap-3 mt-2">
                    ...
                    <p class="text-xs sm:text-sm text-gray-500">申請日: {{ formatDate(team.created_at) }}</p>
                  </div>
                </div>
              </div>
              ...
              <div
                ...
                class="bg-red-50 rounded-xl p-4 sm:p-6 flex flex-col sm:flex-row gap-4 border-2 border-red-200"
              >
                <div class="mx-auto sm:mx-0 flex-shrink-0">
                  <div class="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-red-300 to-red-600 rounded-lg overflow-hidden shadow-lg">
                    <img 
                      :src="team.teams?.team_logo_url || 'https://via.placeholder.com/96x96?text=Team'" 
                      :alt="team.teams?.team_name"
                      class="w-full h-full object-cover"
                ...
                <div class="flex-1 flex flex-col justify-between text-center sm:text-left">
                  ...
                  <div class="flex flex-col sm:flex-row gap-2 mt-3">
                    <button
                      ...
                      class="w-full sm:flex-1 px-4 py-2 bg-blue-600 text-white text-sm font-bold rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                      ...
                      :disabled="reapplyingTeamId === team.team_id || deletingTeamId === team.team_id"
                      class="w-full sm:flex-1 px-4 py-2 bg-gray-400 text-white text-sm font-bold rounded-lg hover:bg-gray-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
